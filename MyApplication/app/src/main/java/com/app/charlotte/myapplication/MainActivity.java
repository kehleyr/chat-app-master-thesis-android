...
import com.app.charlotte.myapplication.gcmpush.RegistrationIntentService;
...
public class MainActivity extends AppCompatActivity  implements ChatSettingsFragment.OnFragmentInteractionListener{
    ...
    private void selectItem(int position) {
        ...
        String value = getResources().getStringArray(R.array.options)[position];


        Fragment fragment=null;

        if (value.equals(getString(R.string.contacts_string)))
        {

            fragment=new ContactsFragment();

        }
        else if (value.equals(getString(R.string.chat_settings)))
        {
        ...
        else if (value.equals(getString(R.string.chat_help)))
        {
